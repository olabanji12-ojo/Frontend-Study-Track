...
const Login: React.FC = () => {
    ...
    const onSubmit = async (data: LoginForm) => {
        ...
        try {
            ...
            // Our api interceptor unwraps this to { token, user }
    ...
    return (
        <AuthLayout
            title="Welcome Back"
            subtitle="Sign in to your study dashboard"
        >
            <motion.form
            ...
            >
                ...
                <motion.div variants={itemVariants} className="space-y-1.5">
                    <div className="flex justify-between items-center px-1">
                        ...
                        <Link to="/forgot-password" title="Forgot Password" className="text-xs text-brand-indigo hover:text-brand-indigo/80">Forgot?</Link>
                    </div>
                    <div className="relative group">
                ...
                <motion.p variants={itemVariants} className="text-center text-sm text-surface-400 pt-2">
                    ...
                    <Link to="/register" className="text-brand-indigo font-medium hover:underline decoration-brand-indigo/30 underline-offset-4">
                        Sign up
                    </Link>
                </motion.p>
            </motion.form>
